...
import ScreenStartScene from "./scenes/ScreenStart"
import ScreenEndScene from "./scenes/ScreenEnd"
const config = {
	type: Phaser.AUTO,
	parent: "app",
	width: 800,
	...
	scene: [ScreenStartScene, ProjectScene,Screen2Scene,Screen3Scene, Screen4Scene, Screen5Scene, ScreenEndScene],
}
