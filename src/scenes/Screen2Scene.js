...
export default class Screen2Scene extends Phaser.Scene {
    ...
    create(){
		if(this.prevRoom > this.room){
			this.player = this.physics.add.sprite(744, 312, "player").setScale(0.8).setFlipX(true)
		}else {
        this.player = this.physics.add.sprite(64, 408, "player").setScale(0.8)
		}
	...
	switchSceneBackward(){
		this.prevRoom = this.room
		this.scene.start("Project-scene", {prevRoom: this.prevRoom})
		this.scene.sleep("screen2-scene")
	}
